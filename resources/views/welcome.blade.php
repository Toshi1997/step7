                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="2" stroke="currentColor" class="w-8 h-8 text-gray-500">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="m11.25 11.25.041-.02a.75.75 0 0 1 1.063.852l-.708 2.836
                                            a.75.75 0 0 0 1.063.853l.041-.021
                            ...
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    このシステムは、STEP7の管理システム作成課題サンプルアプリです。<br>
                                </div>
                            </div>
                        </div>

                        {{-- カラム2 (右上): 未定 --}}
                        <div class="p-6 md:border-l border-t border-gray-200 dark:border-gray-700 md:border-t-0">
                            <div class="flex items-center">
                                <!-- アイコン -->
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" 
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <div class="ml-12 mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                ...
                                class="inline-block mt-3 px-4 py-2 bg-green-500 text-white rounded">
                                    アカウント作成
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                            ...
                            <div class="ml-12 mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                <p>アカウントをお持ちの方は、以下のボタンからログインできます。</p>
                                <a href="{{ route('login') }}"
